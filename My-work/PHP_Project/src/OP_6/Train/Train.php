...
class Train extends Database
{
    ...
    public function store(){
        ...
        $sqlQuery = "INSERT INTO `train_service` ( `name`, `email`,telephone,member,fromWhere,toWhere,date) VALUES ( ?, ?,?,?,?,?,?);";
    ...
    public function index(){
        ...
        $sqlQuery = "select * from train_service where is_trashed='No'";
    ...
    public function view(){
        ...
        $sqlQuery = "select * from train_service where id =".$this->id;
    ...
    public function update(){
        ...
        $sqlQuery = "UPDATE train_service SET name = ?, email = ?,telephone=?,member=?,fromWhere=?,toWhere=?,date=? where id= $this->id;";
    ...
    public function trash(){
        ...
        $sqlQuery = "UPDATE train_service SET is_trashed =NOW() where id= $this->id;";
    ...
    public function recover(){
        ...
        $sqlQuery = "UPDATE train_service SET is_trashed ='No' where id= $this->id;";
    ...
    public function delete(){
        $sqlQuery ="Delete from train_service where id=$this->id;";
    ...
    public function search($requestArray){
        $sql = "";
        if( isset($requestArray['name']) && isset($requestArray['email']) )  $sql = "SELECT * FROM `train_service` WHERE `is_trashed` ='No' AND (`name` LIKE '%".$requestArray['search']."%' OR `email` LIKE '%".$requestArray['search']."%')";
        if(isset($requestArray['name']) && !isset($requestArray['email']) ) $sql = "SELECT * FROM `train_service` WHERE `is_trashed` ='No' AND `name` LIKE '%".$requestArray['search']."%'";
        if(!isset($requestArray['name']) && isset($requestArray['email']) )  $sql = "SELECT * FROM `train_service` WHERE `is_trashed` ='No' AND `email` LIKE '%".$requestArray['search']."%'";
    ...
    public function indexPaginator($page=1,$itemsPerPage=3){
        ...
        $sqlQuery = "SELECT * from train_service  WHERE is_trashed = 'No' LIMIT $start,$itemsPerPage";
