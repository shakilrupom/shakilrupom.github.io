    ...
    if(isset($_REQUEST['list'])) {
        ...
        $list= 0;
        $road->setData($_REQUEST);
        $singleData = $road->view();
    }
...
<head>
    <title>Email This To A Client</title>
    <meta charset="utf-8">
...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation">
                <a href="create.php"><i class="glyphicon glyphicon-chevron-right"></i> Add New Client</a>
            </li>
            <li role="presentation">
                <a href="index.php"><i class="glyphicon glyphicon-chevron-right"></i> View Client List</a>
            </li>
            <li role="presentation">
                <a href="trashed.php"><i class="glyphicon glyphicon-chevron-right"></i> View Client Trashed</a>
            </li>
        </ul>
    </div>
    <div class="col-md-10">
        <h2>Email This To A Client</h2>
...
if($list){
    ...
    printf("<table>
                        <tr>
                            <td width='50'><strong>Bus Serial Number</strong></td>
                            <td width='50'><strong>Bus Company</strong></td>
                            <td width='250'><strong>Bus Type</strong></td>
                            <td width='250'><strong>Time of Depature</strong></td>
                            <td width='250'><strong>Supervisor Phone Number</strong></td>
                        </tr>");
    ...
    foreach($singleData as $row) {
        ...
        printf("<tr>
                            ...
                            <td width='550'>%s</td>
                            <td width='550'>%d</td>
                       </tr>",$serialNumber,$busCompany,$depature,$busType,$phoneNumber);
...
{
    printf("We'r recommending You: 
        [
            <strong>Bus Serial Number: </strong>%d, 
            <strong>Bus Type: </strong>%s, 
            <strong>depature: </strong>%s,
            <strong>Bus Type: </strong>%s,
            <strong>Phone Number: </strong>%d
        ]",
            $singleData->serialNumber,
            $singleData->busCompany,
            $singleData->depature,
            $singleData->busType,
