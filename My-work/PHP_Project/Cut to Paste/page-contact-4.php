...
<html>
	...
	<body class="contact-bg">
							...
							<li class="selected"><a href="#"><span>Features</span></a>
								...
								<li class="selected"><a href="#"><i class="fa fa-envelope"></i>Contact Pages</a>
									<ul>
										...
										<li class="selected"><a href="page-contact-4.php">Contact 4</a></li>
									</ul>
								</li>
    	...
    	<div class="pageContent tbl wid-30 md-padding p-b-3">
			...
			<div class="copyrights white m-t-2 t-center">© Copyrights <b class="main-color">BOOKRA</b> 2016. All rights reserved.</div>
