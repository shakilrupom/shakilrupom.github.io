		...
		<div class="pageWrapper">
								...
								<li class="selected"><a href="#"><span>Features</span></a>
									...
									<li class="selected"><a href="#"><i class="fa fa-envelope"></i>Contact Pages</a>
										<ul>
											...
											<li class="selected"><a href="page-contact-2.php">Contact 2</a></li>
	    	...
	    	<div class="pageContent">
				...
				<div class="breadcrumbs">
					<div class="container">
						<a href="#">Home</a><i class="fa fa-long-arrow-right main-color"></i><a href="#">Pages</a><i class="fa fa-long-arrow-right main-color"></i><span>Contact 2</span>
					</div>
				</div>
							...
							<div class="col-md-6">
								...
								<div>
									<div class="row m-b-2 over-hidden">
										<div class="col-md-6">
											<ul class="details">
												<li><i class="fa fa-map-marker main-color"></i><span>123, Second Sunrise Suite 40, <br> Avenue New York,USA</span></li>
												<li><i class="fa fa-phone main-color"></i><span><strong>Phone:</strong> (50) 1234 567890</span></li>
												<li><i class="fa fa-fax main-color"></i><span><strong>Fax:</strong> (50) 1234 567891</span></li>
												<li><i class="fa fa-envelope main-color"></i><span><strong>Email:</strong> info@bookra.com</span></li>
											</ul>
										</div>
										<div class="col-md-6">
											<ul class="details">
