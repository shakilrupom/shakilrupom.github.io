		...
		<div class="pageWrapper">
			...
			<header class="top-head transparent semi dark fixed-head">
		    	<div class="container">
			    	<!-- Logo start -->
			    	<div class="logo">
				    	<a href="../view/OP_6/index.php"><img alt="" src="../assets/images/logo-light.png" /></a>
				    </div>
				    <!-- Logo end -->
					...
					<div class="responsive-nav">
						...
						<nav class="top-nav">
							<ul>
								<li><a href="../view/OP_6/index.php"><span>Home</span></a>
									<ul>
								...
								<li><a href="#"><span>Features</span></a>
									...
									<li><a href="#"><i class="fa fa-envelope"></i>Contact Pages</a>
										<ul>
											<li>
												<a href="#">Classic</a>
												<ul>
													...
													<li><a href="page-contact-classic-3.php">Map On Bottom</a></li>
								...
								<li class="selected"><a href="#"><span>Pages</span></a>
									<ul>
										<li class="selected"><a href="page-about-us.php">About us</a></li>
	    	...
	    	<div class="pageContent">
	    		...
	    		<div class="page-title trans-head parallax" style="background-image:url('../assets/img/about us.jpg');background-size: cover;padding: 250px 0" data-stellar-background-ratio="0.4">
					<div class="container">
						<div class="tbl p-a-3 black-tr-bg m-l-0">
							<h1 class="font-60 white uppercase">About Us</h1>
							<h3 class="white">All you need to know about our company</h3>
						</div>
					</div>
				</div>
				<div class="breadcrumbs">
					<div class="container">
						<a href="#">Home</a><i class="fa fa-long-arrow-right main-color"></i><a href="#">Pages</a><i class="fa fa-long-arrow-right main-color"></i><span>About Us</span>
					</div>
				</div>
				...
				<div class="md-padding">
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="icon-box">
									<i class="fa fa-html5 lg-icon t-left main-color"></i>
									<h4 class="uppercase">Clean, Valid Tour</h4>
									<h6 class="main-bg">Sub Title goes here</h6>
									<p>Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
								</div>
							</div>
							<div class="col-md-4">
								<div class="icon-box">
									<i class="fa fa-bolt lg-icon t-left red-color"></i>
									<h4 class="uppercase">Re-usable Booking</h4>
									<h6 class="main-bg">Sub Title goes here</h6>
									<p>Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
								</div>
							</div>
							<div class="col-md-4">
								<div class="icon-box">
									<i class="fa fa-clock-o lg-icon t-left"></i>
									<h4 class="uppercase">Best privilages</h4>
									<h6 class="main-bg">Sub Title goes here</h6>
									<p>Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit consequipsum.</p>
								</div>
							</div>
				...
				<div class="no-padding">
					<div class="row-eq-height">
						<div class="col-md-6 gry-bg">
							<div class="inner-lg-container">
								
								<div class="heading">
									<h3 class="uppercase heavy">Why <span class="main-color bolder">BOOKRA</span></h3>
								<b class="head-sep"></b></div>
                                <div class="icon-box simple m-b-3">
                                    
                                    <div class="">
                                        <h4 class="uppercase"><i class="fa fa-laptop md-icon main-color"></i>Fully Client satisfiction</h4>
                                        <p class="m-b-0">Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat
                                            votpat dolore</p>
                                    </div>
                                </div>
                                <hr class="devider dev-style3">
                                <div class="icon-box simple m-b-3 m-t-3">
                                    
                                    <div class="">
                                        <h4 class="uppercase"><i class="fa fa-gift md-icon main-color"></i>Easily Booking</h4>
                                        <p class="m-b-0">Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat
                                            votpat dolore</p>
                                    </div>
                                </div>
                                <hr class="devider dev-style3">
                                <div class="icon-box simple m-t-3">
                                    
                                    <div class="">
                                        <h4 class="uppercase"><i class="fa fa-gears md-icon main-color"></i>Valid &amp; Flexible Tour</h4>
                                        <p class="m-b-0">Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat
                                            votpat dolore</p>
                                    </div>
                                </div>
						...
						<div class="col-md-6" style="background:url('../assets/images/bgs/education.jpg') no-repeat 0 0;background-size: cover"></div>
					</div>
				</div>
				...
				<div class="md-padding">
					<div class="container">
		    			<div class="row row-eq-height">
		    				<div class="col-md-6">
		    					<h3>What We Do!</h3>
		    					<p>Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. Lorem ipsum dolor consetuer adipicing sed diam ticidut erat votpat dolore. </p>
		    					<div class="progress-bars xxs-line">
										
									<h5 class="bar-title">Best Service</h5>
									<div class="progress">
									...
									<h5 class="bar-title">Best Management</h5>
									<div class="progress">
									...
									<h5 class="bar-title">Best Facility</h5>
									<div class="progress">
									...
									<h5 class="bar-title">Well Trained Guide</h5>
									<div class="progress">
		    				...
		    				<div class="col-md-5">
		    					...
		    					<div class="main-bg t-center">
									<div class="horizontal-slider" data-slides_count="1" data-slider-fade="1" data-scroll_amount="1" data-slider-speed="300" data-slider-infinite="1" data-slider-dots="0" data-slider-arrows="1">
										<div class="p-a-2">
											<i class="circle testi_img"><img alt="" src="../assets/images/testimonials/1.jpg"></i>
											<div class="icon-simple-desc">
												<p>Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit conseq uipsum velit auctor enean sollicitud.</p>
											</div>
											<h5 class="black-color testimonials-name">Gregory Fowler : Tourist</h5>
										</div>
										<div class="p-a-2">
											<i class="circle testi_img"><img alt="" src="../assets/images/testimonials/2.jpg"></i>
											<div class="icon-simple-desc">
												<p>Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit conseq uipsum velit auctor enean sollicitud.</p>
											</div>
											<h5 class="black-color testimonials-name">Alice Carpenter: Tourist</h5>
										</div>
										<div class="p-a-2">
											<i class="circle testi_img"><img alt="" src="../assets/images/testimonials/3.jpg"></i>
											<div class="icon-simple-desc">
												<p>Proin gravida nibh vel velit auctor enean sollicitud lorem quis bibendum auctor, nisi elit conseq uipsum velit auctor enean sollicitud.</p>
											</div>
											<h5 class="black-color testimonials-name">Ellina Williams:Tourist</h5>
										</div>
									</div>
								</div>
		    				</div>
				...
				<div class="md-padding gry-bg">
					...
					<div class="container">
						...
						<div class="heading main centered">
							<h3 class="uppercase lg-title">What We <span class="main-color">Offer</span></h3>
							<p>Our Main Goal is to give Client Priority</p>
						</div>

						<div class="row">
							<article class="col-md-4 feature-img fx animated fadeInUp" data-animate="fadeInUp">
								<figure class="lg">
									<img alt="" src="../assets/img/travel%201.jpg" style="width : 300px; height : 217px;">
								</figure>
								<div class="feature-details">
									<h4 class="heavy uppercase">Why Choose BOOKRA</h4>
									<h5 class="main-color">We  Work With Love</h5>
									<p class="">Mauris in quam tristique, dignissim urna in, molestie felis. Fusce tristique, elit nec vehicula imperdiet, eros est egestas odio. Fusce tristique, elit nec vehicula imperdiet, eros est egestas odio, at aliquet elit nulla sed. </p>
								</div>
							</article>
							<article class="col-md-4 feature-img fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="200" style="animation-delay: 200ms;">
								<figure class="lg">
									<img alt="" src="../assets/img/travel%202.jpg" style="width : 300px; height : 217px;">
								</figure>
								<div class="feature-details">
									<h4 class="heavy uppercase">What We DO!</h4>
									<h5 class="main-color">Beautiful web for you</h5>
									<p class="">Mauris in quam tristique, dignissim urna in, molestie felis. Fusce tristique, elit nec vehicula imperdiet, eros est egestas odio. Fusce tristique, elit nec vehicula imperdiet, eros est egestas odio, at aliquet elit nulla sed. </p>
								</div>
							</article>
							<article class="col-md-4 feature-img fx animated fadeInUp" data-animate="fadeInUp" data-animation-delay="400" style="animation-delay: 400ms;">
								<figure class="lg">
									<img alt="" src="../assets/img/travel%203.jpg" style="width : 300px; height : 217px;">
								</figure>
								<div class="feature-details">
									<h4 class="heavy uppercase">Colorizing Life</h4>
									<h5 class="main-color">Awesome Travel Packages for you</h5>
									<p class="">Mauris in quam tristique, dignissim urna in, molestie felis. Fusce tristique, elit nec vehicula imperdiet, eros est egestas odio. Fusce tristique, elit nec vehicula imperdiet, eros est egestas odio, at aliquet elit nulla sed. </p>
								</div>
							</article>
						</div>
				...
				<div class="md-padding">
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="heading main centered">
								<h3 class="uppercase lg-title">Our <span class="main-color">Managing Team</span></h3>
								<p>Our Main Goal is to Best service for all</p>
							</div>
							...
							<div class="col-md-6">
								<div class="team-box box-5">
									...
									<div class="team-details">
										<h4 class="team-name">
											Mohamed Abdelfattah<br>
											<span class="main-color">Manager</span>
										</h4>
							...
							<div class="col-md-6">
								<div class="team-box box-5">
									...
									<div class="team-details">
										<h4 class="team-name">
											Lina Mohamed<br>
											<span class="main-color">SEO Manager</span>
										</h4>
										<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
									</div>
									<div class="team-socials">
		    	...
		    	<div class="footer-top">
		    		<div class="container">
						<p class="lg-txt f-left">
							Our Main Goal is to Create Best Fecility <span class="main-color heavy">BOOKRA</span> All You Need.
						</p>
