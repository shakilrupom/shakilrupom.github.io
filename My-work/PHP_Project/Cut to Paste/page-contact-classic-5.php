...
<html>
	<head>
		...
		<title>Contact Classic Full Bottom Map | BOOKRA</title>
		...
		<div class="pageWrapper">
										...
										<ul>
											<li class="selected">
												...
												<ul>
													...
													<li class="selected"><a href="page-contact-classic-5.php">Full Map On Bottom</a></li>
												</ul>
											</li>
	    	...
	    	<div class="pageContent">
	    		...
	    		<div class="page-title">
					<div class="container">
						<h1>Contact Classic Full Map On Bottom</h1>
						<h3>This is sub heading text to describe the page functionality</h3>
					</div>
				</div>
				<div class="breadcrumbs">
					<div class="container">
						<a href="#">Home</a><i class="fa fa-long-arrow-right main-color"></i><a href="#">Pages</a><i class="fa fa-long-arrow-right main-color"></i><span>Contact Classic Full Map On Bottom</span>
					</div>
				</div>
